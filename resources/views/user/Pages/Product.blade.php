...
<section class="section ec-product-tab section-space-p" id="collection">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <ul class="ec-pro-tab-nav nav justify-content-center">
                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab-pro-for-all"> Products By Category
                                </a></li>
            ...
            @foreach ($response as $categoryName => $products)
            <div class="row">
                <h2 class="ec-bg-title">{{$categoryName}}</h2>
                <hr>
                <div class="col">
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                ...
                                                <a class="quickview"
                                                   data-id="{{ $product->id }}"><i class="fi-rr-eye"></i></a>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <span class="ec-price">
                                                <span class="new-price">PKR {{ $product->price }}</span>
                                            </span>
